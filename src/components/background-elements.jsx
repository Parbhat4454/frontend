  ...
  return (
    <div className="">
      ...
      <motion.div initial={{ opacity: 0 }}
        ...
        transition={{ duration: 0.8, ease: "easeOut" }} className="fixed top-[82%] left-[75%] md:top-[72%] md:left-[82%] w-full h-screen bg-cover z-50">
