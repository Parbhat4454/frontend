    ...
    >
      ...
      >
        ...
        <div  className="mb-8 " variants={itemVariants}>
          <Button
            variant="outline"
            className="w-[225px] h-[48px]  opacity-100 rounded-[50px] px-[44px] gap-[10px]"
          >
            <p className="font-poppins font-semibold text-[16px] leading-[48px] tracking-normal text-center normal-case small-caps">PRIVACY POLICY</p>
